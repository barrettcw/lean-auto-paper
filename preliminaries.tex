...
\subsection{Dependent Type Theory}\label{subdtt}
  ...
  sect. \ref{labstalgo}. ``Dependent argument'' and ``static dependent argument'' usually have the same
  meaning. Their difference will be explained in sect. \ref{exqdet}.
...
\subsection{Lean and Mathlib}\label{sectlean}
  ...
  These features and how Lean-auto handles them will be discussed in sect. \ref{sectprep}.

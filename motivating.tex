...
The Lean proof state of the problem we will consider is shown in Figure \ref{leanlistpretty}.
...
It must be noted that whether an argument is dependent depends on how previous arguments

...
We assume that excluded middle, i.e. $\mathsf{em} : \forall (p : \mathsf{U}_0), p \lor \neg p$,
is implicitly contained in the hypotheses of all $\lambda C$ problems. Similarly,
...
$p \cong \overline{\sigma}(\pi^*(p'))$, and that $p'$ retains as much information of $p$ as
possible.
